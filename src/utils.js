...
SUtils.cutBitmap = function(srcBitmap, width, height, type) {
  var bitmaps = [];
  switch (type) {
    case 0:
...
SUtils.cutBitmapConfig = function(srcBitmap, config) {
  var bitmaps = [];
...
SUtils.cut = function(srcBitmap, dx, dy, number, width, height) {
  var bitmaps = [];
